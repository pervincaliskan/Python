...
# Veri dönüşümlerini uygulayalım
# 1. Min-Max Normalizasyonu
scaler = MinMaxScaler()
X_normalized = pd.DataFrame(scaler.fit_transform(X), columns=X.columns)

# 2. Logaritmik Dönüşüm
X_log = np.log1p(X)
...
# Sınıflandırma ve değerlendirme fonksiyonu
...
# Orijinal ve dönüştürülmüş veri setlerini sınıflandıralım
...
# Veri dağılımlarını görselleştirelim
